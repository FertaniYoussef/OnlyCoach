 ...
 */
final class Version20230222171142 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE coach CHANGE nom nom VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE coach CHANGE nom nom VARCHAR(255) NOT NULL');
