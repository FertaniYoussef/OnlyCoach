 ...
 */
final class Version20230223103515 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE coach DROP id_abonnement, CHANGE offre offre_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE coach ADD CONSTRAINT FK_3F596DCC4CC8505A FOREIGN KEY (offre_id) REFERENCES offre (id) ON DELETE CASCADE');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_3F596DCC4CC8505A ON coach (offre_id)');
        ...
        $this->addSql('ALTER TABLE commentaire ADD id INT AUTO_INCREMENT NOT NULL, DROP contenu, CHANGE auteur auteur VARCHAR(255) NOT NULL, CHANGE date date DATETIME NOT NULL, ADD PRIMARY KEY (id)');
        $this->addSql('ALTER TABLE offre DROP FOREIGN KEY FK_AF86866F6CCBBA04');
        $this->addSql('ALTER TABLE offre ADD CONSTRAINT FK_AF86866F6CCBBA04 FOREIGN KEY (id_coach_id) REFERENCES coach (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_3F596DCC4CC8505A ON coach');
        $this->addSql('ALTER TABLE coach DROP FOREIGN KEY FK_3F596DCCBCF5E72D');
        $this->addSql('ALTER TABLE coach ADD id_abonnement INT NOT NULL, CHANGE offre_id offre INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE commentaire ADD contenu TEXT NOT NULL, DROP id, CHANGE auteur auteur TEXT NOT NULL, CHANGE date date INT NOT NULL');
        $this->addSql('ALTER TABLE offre DROP FOREIGN KEY FK_AF86866F6CCBBA04');
